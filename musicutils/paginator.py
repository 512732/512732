...
class Pages:
    ...
    async def show_page(self, page, *, first=False):
        ...
        self.embed.set_footer(text='Page {}/{} ({} entries)'.format(page, self.maximum_pages, len(self.entries)))
    ...
    async def numbered_page(self):
        ...
        try:
            ...
            if page != 0 and page <= self.maximum_pages:
                ...
                to_delete.append(await self.ctx.send('Invalid page given. ({}/{})'.format(page, self.maximum_pages)))
    ...
    async def show_help(self):
        ...
        for (emoji, func) in self.reaction_emojis:
            messages.append('{} {}'.format(emoji, func.__doc__))

        e.description = '\n'.join(messages)
        e.colour = 0x738bd7  # blurple
        e.set_footer(text='We were on page {} before this message.'.format(self.current_page))
